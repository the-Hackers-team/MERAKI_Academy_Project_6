...
///select users.id,firstName,lastName,users.user_image from subscriptions INNER JOIN users ON users.id = subscriptions.chanel_id where user_id=? is_deleted = 0
