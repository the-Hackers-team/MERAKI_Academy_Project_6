...
subsciptionRouter.delete("/delete/subscripe/:id", authentication, removeFromMySubscription);

//create end point to add Video to LikesContoller

subsciptionRouter.post("/add/:id", authentication, addToSubscription);

subsciptionRouter.get("/mySubsciption", authentication, getMySubscriptionChannels);
